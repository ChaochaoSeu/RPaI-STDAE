...
TARGET_FEATURES = [0]
time_of_day_size = int(24*60/sampling_granularity)
...
MODEL_PARAM = {
    ...
    "blocks": 4,
    "layers": 2,
    "days": 7, # the `days` parameter used in STPGNN
    "time_of_day_size": time_of_day_size,  # Number of time steps in a day in the specific dataset
    "dims": 32,
    "order": 2,
    "in_dim": 6,  # Number of input features
    "normalization": "batch"
}
NUM_EPOCHS = 100

...
MODEL_ARCH = STDAEGWNET
adj_mx, _ = load_adj("datasets/" + DATA_NAME + "/adj_mx.pkl", "doubletransition")
MODEL_PARAM = {
    "dataset_name": DATA_NAME,
    "pre_trained_tae_path": "baselines/STDAEAblation/pretrain_save/STDAE_TAE/XueBu_5min_100_288_288_history_turn_reconstruct/d84ca2151a2e6bc7224d1d9ddebdc7b5/STDAE_TAE_best_val_MAE.pt",
    "pre_trained_sae_path": "baselines/STDAEAblation/pretrain_save/STDAE_SAE/XueBu_5min_100_288_288_history_turn_reconstruct/f0940a191572fa81c3fb09ef40a85028/STDAE_SAE_best_val_MAE.pt",
    "stdae_args": {
        "patch_size":12,
        "in_channel": 4,
        "embed_dim": 96,
...
# 提前停止
CFG.TRAIN.EARLY_STOPPING_PATIENCE = 20  # 提前停止的耐心值。默认值：None。如果未指定，则不会使用提前停止。

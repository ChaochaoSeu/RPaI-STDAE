...
class STDAED2STGNN(nn.Module):

    def __init__(self, dataset_name, pre_trained_tae_path, pre_trained_sae_path, stdae_args, d2stgnn_args,
        ...
        self.backend = D2STGNN(**d2stgnn_args)

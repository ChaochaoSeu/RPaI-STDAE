...
class STDAESTAEformer(nn.Module):

    def __init__(self, dataset_name, pre_trained_tae_path, pre_trained_sae_path, stdae_args, staeformer_args,
        ...
        self.backend = STAEformer(**staeformer_args)

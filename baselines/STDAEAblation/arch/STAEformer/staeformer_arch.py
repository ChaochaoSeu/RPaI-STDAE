...
class STAEformer(nn.Module):
    ...
    def __init__(
        ...
        self.fc_his_t = nn.Sequential(nn.Linear(96, 512), nn.ReLU(), nn.Linear(512, self.in_steps * self.model_dim), nn.ReLU())
        self.fc_his_s = nn.Sequential(nn.Linear(96, 512), nn.ReLU(), nn.Linear(512, self.in_steps * self.model_dim), nn.ReLU())

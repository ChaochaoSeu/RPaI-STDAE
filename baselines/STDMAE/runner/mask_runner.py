...
class MaskRunner(SimpleTimeSeriesForecastingRunner):
    ...
    def forward(self, data: tuple, epoch:int = None, iter_num: int = None, train:bool = True, **kwargs) -> tuple:
        ...
        # print(f"reconstruction_masked_tokens.shape:{reconstruction_masked_tokens.shape},label_masked_tokens.shape:{label_masked_tokens.shape},history_data.shape:{history_data.shape}")

...
INPUT_LEN = regular_settings['INPUT_LEN']  # Length of input sequence # 采样粒度10min
OUTPUT_LEN = regular_settings['OUTPUT_LEN']  # Length of output sequence # 采样粒度10min
# INPUT_LEN = 24  # Length of input sequence # 采样粒度5min
# OUTPUT_LEN = 24  # Length of output sequence # 采样粒度5min
TRAIN_VAL_TEST_RATIO = regular_settings['TRAIN_VAL_TEST_RATIO']  # Train/Validation/Test split ratios
NORM_EACH_CHANNEL = regular_settings['NORM_EACH_CHANNEL'] # Whether to normalize each channel of the data
RESCALE = regular_settings['RESCALE'] # Whether to rescale the data
NULL_VAL = regular_settings['NULL_VAL'] # Null value in the data

SELECTED_CHANNELS = [0, 10, 11]
TARGET_FEATURES = [0]
...
HIMNET_CONFIG = {
  ...
  'milestones': [20, 40, 80],
  'clip_grad': 5,
  # 'batch_size': 16, #采样粒度10min
  'batch_size': 32, #采样粒度5min
  'max_epochs': 100,
  'early_stop': 10
}
...
MODEL_PARAM = {
    ...
    'input_dim': 3,
    'output_dim': 1,
    'timestep_oneday':timestep_oneday,
    'tod_embedding_dim': 6,
    'dow_embedding_dim': 6,
